...
export const metadata: Metadata = {
  title: "Mehmet URHAN | ionBATech",
  description: "Mehmet URHAN Dijital Kartvizit",
  robots: {
    index: false,
    follow: false,
  },
...
export default function Kartvizit2() {
  return (
    <>
      <SiteHeader />
        ...
        <div className="ionbatech-widget">
          <div className="digital-card">
            ...
            <div className="contact-list">
              <a className="contact-row" href="tel:+905433793858">
                <i className="fa-solid fa-phone"></i> +90 543 379 38 58
              </a>
              <a className="contact-row" href="mailto:info@ionbatech.com">
                <i className="fa-solid fa-envelope"></i> info@ionbatech.com
              </a>
              <a className="contact-row" href="https://www.google.com/maps/search/?api=1&query=Mevlana+Mh.+Şht.+Fatih+Duman+Sk.+No:34/B+Talas+Kayseri" target="_blank" rel="noopener noreferrer">
